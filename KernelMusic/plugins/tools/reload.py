...
from KernelMusic import app
from KernelMusic.core.call import Kernel
from KernelMusic.misc import db
from KernelMusic.utils.database import get_authuser_names, get_cmode
from KernelMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from KernelMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Kernel.stop_stream(message.chat.id)
    except:
        pass
